...
def test_server_returns_t5_position_action_with_current_rotation():
    ...
    np.testing.assert_allclose(payload["target_t5_R_ee"], current[:3, :3], atol=1e-12)
    ...
    assert math.isclose(payload["servo_step"]["wrist_step_rad"], 0.0, abs_tol=1e-12)
